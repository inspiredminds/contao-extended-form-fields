[![](https://img.shields.io/maintenance/yes/2019.svg)](https://github.com/inspiredminds/contao-extended-form-fields)
...
* Adds a _minimum options_ and _maximum options_ setting to checkbox fields and multiple select fields.
* Allows you to define a custom error message in the form field's options.
* Adds the ability to provide a custom input field for radio button form fields.
