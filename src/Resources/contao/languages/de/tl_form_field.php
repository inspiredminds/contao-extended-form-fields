...
$GLOBALS['TL_LANG']['tl_form_field']['disallowedValues'] = ['Nicht erlaubte Werte', 'Diese Werte verursachen einen Fehler bei der Validierung.'];
$GLOBALS['TL_LANG']['tl_form_field']['allowedValues'] = ['Erlaubte Werte', 'Nur diese Werte werden erlaubt.'];
