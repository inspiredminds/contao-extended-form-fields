...
$GLOBALS['TL_LANG']['tl_form_field']['disallowedValues'] = ['Disallowed words', 'These words will create a validation error on submit.'];
$GLOBALS['TL_LANG']['tl_form_field']['allowedValues'] = ['Allowed values', 'Only these words or values will be allowed.'];
